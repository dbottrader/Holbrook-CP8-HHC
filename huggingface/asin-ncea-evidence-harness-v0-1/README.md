...
> **Mirror notice:** Hugging Face is a public execution and distribution surface, not the canonical provenance store. The canonical source remains [dbottrader/Holbrook-CP8-HHC](https://github.com/dbottrader/Holbrook-CP8-HHC).

- **Creator/steward:** Dennis M. Christie (CP8)
- **Public provenance:** [PUBLIC_PROVENANCE_RECORD.md](https://github.com/dbottrader/Holbrook-CP8-HHC/blob/main/docs/PUBLIC_PROVENANCE_RECORD.md)
- **Broader live runtime:** [ASIN-HHC Harmony Core CP8](https://asin-hhc-harmony-core-cp8-fzhm29.v2.appdeploy.ai/)
- **Recovered package source:** [Holbrook-CP8-HHC PR #10](https://github.com/dbottrader/Holbrook-CP8-HHC/pull/10)
